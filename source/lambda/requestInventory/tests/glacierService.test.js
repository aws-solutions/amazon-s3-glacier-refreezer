        ...
        before(function () {
            ...
            const successResult = {
                data: {
                    ...
                    location:
                        "/111122223333/vaults/examplevault/jobs/HkF9p6o7yjhFx-K3CGl6fuSm6VzW9T7esGQfco8nUXVYwS0jlb5gq1JZ55yHgt5vP54ZShjoQzQVVh7vEXAMPLEjobID",
                },
                err: null,
            };
            const failedResult = {
            ...
            initiateJobFunc
                .withArgs(
                    sinon.match(function (param) {
                        return (
                            param.jobParameters.Description === validJobName &&
                            param.jobParameters.Type === retrievalType
                        );
                    })
                )
                .returns({
