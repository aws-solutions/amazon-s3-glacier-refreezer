...
# and the lambda packages from regional-s3-assets to a SINGLE bucket
#
# Arguments:
#  - BUCKET      : actual bucket name to upload to. **MUST** match <BUCKET_BASE>-<REGION> format, where BUCKET_BASE **MUST* be as used for build-dist-s3.sh
#  - SOLUTION
#  - VERSION
